...
% Methode 4 : Estimation de la vitesse moyenne de la voiture par le maximum
v_moyenne = max(abs(v_r)); % Approche simple par le maximum
v_moyenne_kmh = v_moyenne * 3.6;
...
fprintf('max de v_r : %.2f m/s (soit %.2f km/h)\n', v_moyenne, v_moyenne_kmh);
